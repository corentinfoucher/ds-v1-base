...
export const componentList: ComponentEntry[] = [
  ...
  { slug: "ask-user-questions", name: "AskUserQuestions", description: "Stepped question flow with single/multi-select, optional 'other' input, and skip.", isUpdated: true, gridSize: "large" },
